...
Los índices de diversidad son herramientas sencillas que nos permiten analizar la composición de un sitio y de los individuos presentes en una comunicad, la forma en que la comunidad esta organizada y la riqueza total del sitio (Inventarios E Índices de Diversidad Agrícola En Fincas Campesinas de Dos Municipios del Valle del Cauca, Colombia| Entramado, s. f.).  Este tipo de análisis pueden ser utilizados para determinar la estructura de una comunidad y su relación con la función que en conjunto o en separado las especies llevan a cabo. Estudios de conservación y de diversidad de microbiota son el tipo de estudios que emplean los índices de diversidad. 
